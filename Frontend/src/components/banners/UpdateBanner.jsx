...
import classes from "./UI/UpdateBanner.module.css";
...
function UpdateBanner() {
    ...
    useEffect(() => {
        ...
        document.getElementById("textField").value = params.textField
        setError(false)
    }, [params.id]);
    ...
    function handleClickDelete() {
        axios
            .delete(`http://localhost:8080/banners/${params.id}`, {
                headers: {
                    'Authorization': `Bearer ${Cookies.get('token')}`,
                }
            })
    ...
    function handleClickSave() {
        ...
        let array = []
        value.map(value1 => {
            array.push(value1.requestId)
        })
        axios
            .put(`http://localhost:8080/banners`, {
                id: params.id,
                name: name.value,
                price: price.value,
